...
class ArtistController extends Zend_Controller_Action
{
    ...
    {
    // fron controller routes /artist/list-all-artists to artist::listAction() now
    echo "list all artists failed! check routing";
    }
     ...
     * Display news for users artist.
     ...
     public function newsAction()
     {
       ...
       $this->view->setScriptPath("/var/www/loudbite/application/views/scripts/artists");
       $this->render("news");
    ...
    private function getAddArtistForm()
    {
        ...
        $form->setDescription("addartist form");
	...
	$genreElement->setLabel('Genre:');
        ...
        $genreElement->setMultiOptions($genres); // $recordset is collection of record which is from database
	// foreach ($genres as $k => $v) {
	//    $genreElement->addMultiOption($k, $v);
	// }
	// unset($k);
	// unset($v);
...
else
{
    ...
    public function listPhotosAction()
    {
        ...
        try
        {
          ...
          $flickr = new Zend_Service_Flickr($this->flickr_api_key);
